...
Y.namespace('M.atto_indent').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    initializer: function() {
        ...
        this.addToolbarMenu({
            ...
            group: true,
            items: [
                {'icon': 'e/decrease_indent', 'title': 'outdent', 'buttonName': 'outdent', 'callback': this.outdent},
                {'icon': 'e/increase_indent', 'title': 'indent', 'buttonName': 'indent', 'callback': this.indent},
            ]
        });
        ...
        host.on('atto:selectionchanged', function (e) {
            Y.soon(Y.bind(function (e) {
                if (host.selectionFilterMatches('div[class*="editor-indent"]', e.selectedNodes, false)) {
